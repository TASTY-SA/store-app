...
export function ResumenPedido({ subtotal, totalItems, onCheckout }: ResumenPedidoProps) {
  ...
  return (
    <div className="rounded-3xl border border-[#e8e5c0] bg-[#fdfbd7]/50 p-6 shadow-sm">
      ...
      <button
        onClick={onCheckout}
        disabled={subtotal === 0}
        className="mt-6 w-full flex items-center justify-center gap-2 rounded-2xl bg-[#1F8848] py-3.5 text-base font-bold text-white shadow-lg shadow-[#1F8848]/30 transition-all duration-200 hover:bg-[#40A360] hover:shadow-xl hover:shadow-[#1F8848]/40 active:scale-[0.98] disabled:bg-gray-300 disabled:shadow-none disabled:cursor-not-allowed"
      >
